...
Workflows are markdown files stored in `.builder/workflows/`:

- **Global workflows**: `~/.builder/workflows/` (available in all projects)
- **Project workflows**: `[project]/.builder/workflows/` (project-specific)
...
Create a file called `submit-pr.md` in your `.builder/workflows` directory:
