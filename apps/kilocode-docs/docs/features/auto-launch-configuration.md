...
1. Create a `.builder` directory in your workspace root (if it doesn't exist)
2. Create a `launchConfig.json` file inside the `.builder` directory
...
1. Verify file location: `.builder/launchConfig.json` in workspace root
