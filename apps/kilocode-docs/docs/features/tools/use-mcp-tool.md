...
- **Project-level Configuration**: Defined in a `.builder/mcp.json` file within your project's root directory.
...
- Since `.builder/mcp.json` can be committed to version control, it simplifies sharing configurations with your team.
