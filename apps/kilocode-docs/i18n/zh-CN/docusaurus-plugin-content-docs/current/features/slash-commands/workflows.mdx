...
工作流是存储在 `.builder/workflows/` 中的 markdown 文件：

- **全局工作流**：`~/.builder/workflows/`（在所有项目中可用）
- **项目工作流**：`[project]/.builder/workflows/`（项目特定）
...
在您的 `.builder/workflows` 目录中创建一个名为 `submit-pr.md` 的文件：
