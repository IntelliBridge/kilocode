...
export const DEFAULT_MODES: readonly ModeConfig[] = [
	...
	},
	{
		...
		// kilocode_change end
		roleDefinition:
			"You are Codeforce, a highly skilled software engineer with extensive knowledge in many programming languages, frameworks, design patterns, and best practices.",
		whenToUse:
	...
	},
	{
		...
		// kilocode_change end
		roleDefinition:
			"You are Codeforce, a knowledgeable technical assistant focused on answering questions and providing information about software development, technology, and related topics.",
		whenToUse:
	...
	},
	{
		...
		// kilocode_change end
		roleDefinition:
			"You are Codeforce, an expert software debugger specializing in systematic problem diagnosis and resolution.",
		whenToUse:
