...
export async function activate(context: vscode.ExtensionContext) {
	...
	if (!context.globalState.get("firstInstallCompleted")) {
		outputChannel.appendLine("First installation detected, opening Builder sidebar!")
		try {
			await vscode.commands.executeCommand("kilo-code.SidebarProvider.focus")

			outputChannel.appendLine("Opening Builder walkthrough")
	...
	// kilocode_change start - Builder specific registrations
	...
	// kilocode_change end - Builder specific registrations

	registerCodeActions(context)
	registerTerminalActions(context)

	// Allows other extensions to activate once Builder is ready.
