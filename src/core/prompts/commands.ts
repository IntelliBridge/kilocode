...
The user has explicitly asked you to help them create a new Kilo rule file inside the .builder/rules top-level directory based on the conversation up to this point in time. The user may have provided instructions or additional information for you to consider when creating the new Kilo rule.
...
Usage:
<new_rule>
<path>.builder/rules/{file name}.md</path>
<content>Kilo rule file content here</content>
</new_rule>
Example:
<new_rule>
<path>.builder/rules/project-preferences.md</path>
<content>
## Brief overview
