...
/**
 * Converts .builder/rules file to directory and places old .builder/rules file inside directory, renaming it
 * Doesn't do anything if .builder/rules dir already exists or doesn't exist
